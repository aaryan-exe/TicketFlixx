...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="InterstellarTrailerStyle.css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="movies-container">
        ...
        <div class="movie">
            ...
            <a href="MovieDetails.aspx?title=Avatar">
                 <asp:Button ID="Avatarbtn" runat="server" CssClass="book-btn" Text="Book Now" OnClick="Avatarbtn_Click" />
            </a>
        </div>
    ...
    <div class="movie">
        ...
        <div class="rating">★ 9.0/10</div>
         <asp:Button ID="BatmanTrailer" runat="server" CssClass="book-btn" Text="Book Now" OnClick="BatmanTrailer_Click"/>
    </div>
    <!-- Movie 5 -->
    <div class="movie">
