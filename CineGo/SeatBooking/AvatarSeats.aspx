<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AvatarSeats.aspx.cs" Inherits="CineGo.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container">
            <!-- Poster Section (Left) -->
            <div class="poster">
                <img id="interImage" src="/Images/AvatarPoster.jpeg" width="300" height="400px" alt="Movie Poster" />
            </div>
