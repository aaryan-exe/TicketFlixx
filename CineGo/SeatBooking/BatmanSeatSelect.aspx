<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatmanSeatSelect.aspx.cs" Inherits="CineGo.SeatBooking.BatmanSeatSelect" %>
...
<div class="heading">
    ...
    <div class="info">
        ...
        <div class="container">
            <!-- Poster Section (Left) -->
            <div class="poster">
                <img id="interImage" src="/Images/Batman.jpg" width="300" height="400px" alt="Movie Poster" />
            </div>
