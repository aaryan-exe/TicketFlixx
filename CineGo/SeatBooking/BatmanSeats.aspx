<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BatmanSeats.aspx.cs" Inherits="CineGo.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container">
            <!-- Poster Section (Left) -->
            <div class="poster">
                <img id="interImage" src="/Images/BatmanPoster.jpg" width="300" height="400px" alt="Movie Poster" />
            </div>
